import './_astro_actions_DNOVdKl4.mjs';
import { Resend } from 'resend';
import { d as defineAction } from './server_CYCPpZWW.mjs';
import { A as ActionError } from './astro-designed-error-pages_PoPftJ9Y.mjs';

const resend = new Resend("re_XJxP8WaS_JQdTLaxwKLHzt44VCqMcgXV8");
const server = {
  send: defineAction({
    accept: "form",
    handler: async (e) => {
